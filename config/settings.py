...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Backend for the Innovation Launchpad',
    'VERSION': '1.0.0',
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "phases.InnovationPhase": "fas fa-layer-group",
        "phases.PhaseField": "fas fa-list",
        "phases.PromptChunk": "fas fa-puzzle-piece",
        "responses.PhaseResponse": "fas fa-comment-dots",
        "activity.ActivityLog": "fas fa-history",
    },
    "default_icon_parents": "fas fa-chevron-circle-right",
    "default_icon_children": "fas fa-circle",
    "related_modal_active": True,
    "custom_css": "custom.css",
    "custom_js": "admin_fx.js",
